...
export default function VocalSelectCategoryEdit(props: ProducerSelectCategoryEditProps) {
  const { selectCategory } = props;
  const { id } = useParams();
  const prevValues = useGetVocalProfile(Number(id)).vocalProfile?.userProfile.userCategory;
