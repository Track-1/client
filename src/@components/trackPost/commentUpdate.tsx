    ...
    <>
      <WriteContainer>
        ...
        <InfoBox>
          ...
          <InputWrapper>
            <InputBox defaultValue={comment} maxLength={150} onChange={changeCommentLength} ref={commentText} />
          </InputWrapper>
        </InfoBox>
      </WriteContainer>
...
const CountWrapper = styled.div`
  ...
  ${({ theme }) => theme.fonts.description}//  margin-left: 54.1rem;
`;
