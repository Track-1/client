export const UsingSitePolicy = {
  ...
  INTRO: "",
  CONTENTS: [
    "<b>제1조(목적)</b>\n이 약관은 Track 1 (이하 '회사' 라고 합니다)가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.",
    ...
    "1. 트랙 검색/업로드/다운로드 서비스",
    "2. 보컬 검색 서비스",
    "3. 뮤지션 프로필 서비스",
    "4. 기타 사용자의 편의를 위하여 제공하는 서비스",
    "<b>제14조(서비스의 제한 등)</b>",
